...
public final class gaosu_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("  </head>\n");
      out.write("  \n");
      out.write("  <title>治超管理 高速检测表</title>\n");
      out.write(" 高速检测表 \n");
      out.write(" ");

     out.println("<button type=\"button\" onclick=\"window.location.href='index.jsp'\">精确检测表</button >"); 
    ...
    out.println("<button type=\"button\" onclick=\"window.location.href='tongxing.jsp'\">超限运输车辆通行证表</button >"); 
      ...
      out.write("            \t\t\t\t\n");
      out.write("            \t\t\t\t<h3>车牌号码&nbsp;&nbsp;&nbsp;&nbsp;发文单位&nbsp;&nbsp;&nbsp;&nbsp;车货总重&nbsp;&nbsp;&nbsp;&nbsp;轴重&nbsp;&nbsp;&nbsp;&nbsp;数据产生时间&nbsp;&nbsp;&nbsp;&nbsp;联系人</h3><br>\n");
      out.write("            \t\t\t\t\n");
      out.write("  ");
  ...
  while(i<100)
  {
				...
				if (!file.exists() || !file.isFile()) {
    				...
    				int i3=xx.indexOf("车货总重");
    				String s3=xx.substring(i3+5,dom4j.findnext(xx, i3, ','));        		
    				
    				int i4=xx.indexOf("轴重");
    				String s4=xx.substring(i4+3,dom4j.findnext(xx, i4, ','));        		
