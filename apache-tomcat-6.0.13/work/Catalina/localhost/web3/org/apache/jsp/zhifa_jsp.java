...
public final class zhifa_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("  </head>\n");
      out.write("  \n");
      out.write("  <title>治超管理 超限执法表</title>\n");
      out.write(" 超限执法表\n");
      out.write(" ");
 ...
 out.println("<button type=\"button\" onclick=\"window.location.href='gaosu.jsp'\">高速检测表</button >"); 
    out.println("<button type=\"button\" onclick=\"window.location.href='tongxing.jsp'\">超限运输车辆通行证表</button >");  
      ...
      out.write("            \t\t\t\t\n");
      out.write("            \t\t\t\t<h3>车牌编号&nbsp;&nbsp;&nbsp;&nbsp;发文单位&nbsp;&nbsp;&nbsp;&nbsp;驾驶证号&nbsp;&nbsp;&nbsp;&nbsp;司机姓名&nbsp;&nbsp;&nbsp;&nbsp;数据产生时间&nbsp;&nbsp;&nbsp;&nbsp;联系人</h3><br>\n");
      out.write("            \t\t\t\t\n");
      out.write("  ");
