...
public final class tongxing_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("  </head>\n");
      out.write("  \n");
      out.write("  <title>治超管理 超限运输车辆通行证表</title>\n");
      out.write(" 超限运输车辆通行证表\n");
      out.write(" ");
 ...
 out.println("<button type=\"button\" onclick=\"window.location.href='zhifa.jsp'\">超限执法表</button >"); 
      ...
      out.write("            \t\t\t\t\n");
      out.write("            \t\t\t\t<h3>通行证号&nbsp;&nbsp;&nbsp;&nbsp;发文单位&nbsp;&nbsp;&nbsp;&nbsp;行驶证号&nbsp;&nbsp;&nbsp;&nbsp;运输速度&nbsp;&nbsp;&nbsp;&nbsp;数据产生时间&nbsp;&nbsp;&nbsp;&nbsp;联系人</h3><br>\n");
      out.write("            \t\t\t\t\n");
      out.write("  ");
